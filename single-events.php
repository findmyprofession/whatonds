...
?>
<?php get_header(); ?>
<?php if (!is_user_logged_in()) { ?><style type="text/css">#respond{width: 100%;}</style><?php } ?>
    ...
    <?php while (have_posts()) : ?>
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
            ...
            <div class="shortdescription can_recommend">
                ...
                <div class="seconddown" id="hidethiswithoutlogin">
                    <ul>
...
<script type="text/javascript">
    ...
    jQuery(function () {
        jQuery(".comment-box .seconddown").css("visibility", "visible");
        var ele = jQuery(".seconddown").clone(true);
        setTimeout(function () {
            jQuery(".comment-text").prepend(ele);
             if (jQuery("#hidethiswithoutlogin .event-thumbup .ajax-link i").hasClass("fas")) {
                jQuery(".comment-text .event-thumbdown").hide();
                jQuery(".comment-text .event-thumbup").show();
            }
            if (jQuery("#hidethiswithoutlogin .event-thumbdown .ajax-link i").hasClass("fas")) {
                jQuery(".comment-text .event-thumbup").hide();
                jQuery(".comment-text .event-thumbdown").show();
            }
        }, 2000);
        ...
        jQuery(".event-thumbup").click(function () {
            jQuery(".comment-text .event-thumbdown").hide();
            jQuery(".comment-text .event-thumbup").show();
        });
        jQuery(".event-thumbdown").click(function () {
            jQuery(".comment-text .event-thumbdown").show();
            jQuery(".comment-text .event-thumbup").hide();
        });
...
<?php if (!is_user_logged_in()) { ?>
    <script type="text/javascript">
        jQuery(function () {
            ...
            setTimeout(function () {
                if (jQuery(".event-thumbup .ajax-link i").hasClass("fas")) { alert("here");
                    jQuery(".comment-text .event-thumbdown").hide();
                    jQuery(".comment-text .event-thumbup").show();
                }
                if (jQuery(".event-thumbdown .ajax-link i").hasClass("fas")) {alert("hihere");
                    jQuery(".comment-text .event-thumbup").hide();
                    jQuery(".comment-text .event-thumbdown").show();
                }
                jQuery("#hidethiswithoutlogin").hide();
